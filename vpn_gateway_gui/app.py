...
class MainWindow(QMainWindow):
    ...
    def test_connection(self) -> None:
        self.save_settings()
        self.controller.request(lambda client: client.get_version(), lambda response: QMessageBox.information(self, "Verbindung", f"CLI API-Version {response['api_version']}"))
